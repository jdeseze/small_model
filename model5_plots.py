...
k1 = 0.038
k2 = 0.001  # st.slider('k2 (rt->rd)',0.0,2.0,0.5)
k3 = 0.5  # st.slider('k3 (a+rd->a+rt)',0.0,2.0,0.5)
k4 = 0.01  #k4 (c->m+a)
k5 = 0.001 #k5 (rt+m->mt+rt)
k6 = 0.001 #k6 (mt->m)
k7 = 0.001 # k7 (mt+a->c)
...
def dy(t, y, const):
    ...
    dc = k7*a*mt-k4*c
    dmt = k5*rt*(mtot-mt)+k4*c-k6*mt-k7*a*mt
    #da= -k5*a*rt+k4*c
    k = kon
    t_int = 60
    t_ilid = 20
